...
Partial Public Class ScriptEngine
    ...
    Public Class ScriptPointer
        Public Script As String(), ColumnIndex As Integer, LineIndex As Integer, Filename As String
        Public lPlugin As ScriptEngine
        Public Owner() As String

        Public TokenType As TokenTypes, Token As Object

        Friend LocalVariables As Dictionary(Of String, TypedValue)
        ...
        Public Sub New(Filename As String, lPlugin As ScriptEngine)
            ...
            Script = My.Computer.FileSystem.ReadAllText(Filename).Split({ChrW(13) & ChrW(10), ChrW(13), ChrW(10)}, 0)
            ColumnIndex = 0
            LineIndex = 0
            Me.lPlugin = lPlugin
        End Sub

        ''' <summary>Returns or sets the current one-based line number.</summary>
        ...
        ''' <summary>Returns or sets the current one-based column number.</summary>
        ...
        Public Sub NextToken()
            If TokenType = TokenTypes.tEndOfScript Then Return
            Do
                ...
                Select Case c
                    Case " "c, ChrW(9)
                        ...
                        Continue Do
                    Case ";"c
                        TokenType = TokenTypes.tEndOfLine
                        Token = Nothing
                        ColumnIndex += 1
                        Return
                    Case "0"c To "9"c
        ...
        Public Function UserFriendlyErrorLocation() As String
            ...
            For i = 0 To Script(LineIndex).Length - 1
                If i = ColumnIndex Then
                    ...
                    b.Append(Script(LineIndex)(i))
                    b.Append(ChrW(3) & "5" & ChrW(31))
                Else
                    b.Append(Script(LineIndex)(i))
                End If
            Next
            If ColumnIndex = Script(LineIndex).Length Then b.Append(ChrW(31) & ChrW(3) & "4 ")
            Return b.ToString
        End Function
    End Class

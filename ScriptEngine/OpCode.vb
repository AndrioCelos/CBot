...
Partial Public Class ScriptEngine
    ...
    Public Class OpCodeBinary
        ...
        Private Value1 As OpCode
        Private Value2 As OpCode
        Public Operation As OperatorType
            ...
            Get
                ...
                Select Case Operation
                    ...
                    Case OperatorType.oBooleanImplication
                        Try
                            Return (Not CType(v1, Boolean)) Or CType(v2, Boolean)
                        Catch ex As InvalidCastException
                    ...
                    Case OperatorType.oAnd
                        If TypeOf v1 Is Boolean And TypeOf v2 Is Boolean Then
                            Return DirectCast(v1, Boolean) And DirectCast(v2, Boolean)
                    ...
                    Case OperatorType.oOr
                        If TypeOf v1 Is Boolean And TypeOf v2 Is Boolean Then
                            Return DirectCast(v1, Boolean) Or DirectCast(v2, Boolean)
                        ElseIf TypeOf v1 Is Decimal And TypeOf v2 Is Decimal Then
                    ...
                    Case OperatorType.oDivision
                        ...
                        End If
                    Case OperatorType.oExponentiation
                        If TypeOf v1 Is Decimal And TypeOf v2 Is Decimal Then
                            Return CType(v1 ^ v2, Decimal)
                        Else
                            Throw New ArgumentException("The exponentiation operation cannot be performed on these value of type " & v1.GetType.Name & "and" & v2.GetType.Name & ".")
                        End If
                    Case Else
                        Throw New ArgumentException(Operation & " is not a known operation.")
                End Select
    ...
    Public Class OpCodeVariable
        ...
        Public Overrides ReadOnly Property Value As Object
            Get
                Dim TypedValue As TypedValue
                If Not lPlugin.Variables.TryGetValue(VariableName, TypedValue) Then
    ...
    Public Class OpCodeFunction
        ...
        Private _Args() As OpCode
        Private _MethodName As String
        Private _Script As ScriptPointer
        Private _Connection As IRCConnection
        Private _Channel As String
        Public _Target As OpCode

        Public Sub New(Script As ScriptPointer, MethodName As String, Args() As OpCode, Connection As IRCConnection, Channel As String, Target As Object)
            _Script = Script

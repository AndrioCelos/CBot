...
namespace IRC {
    ...
    public class IRCChannel {
        ...
        public virtual ChannelStatus MyStatus { get; internal set; }
        ...
        /// <summary>The maximum number of users that can join the channel, or int.MaxValue if none is set.</summary>
        public int UserLimit { get; internal set; } = int.MaxValue;
        /// <summary>The key to the channel, or null if none is set.</summary>
        public string Key { get; internal set; }
        /// <summary>The local user's presence on the channel.</summary>
        public IRCChannelUser Me { get; internal set; }
        ...
        public IRCChannel(string name, IRCClient client) {

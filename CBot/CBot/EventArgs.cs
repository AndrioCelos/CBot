...
namespace CBot {
    ...
    public class CommandEventArgs : EventArgs {
        ...
        /// </summary>
        /// <param name="client">The IRCClient object on which the command was heard.</param>
        ...
        public CommandEventArgs(IRCClient client, string channel, IRCUser sender, string[] parameters) {
            this.Client = client;
    ...
    public class RegexEventArgs : EventArgs {
        ...
        /// </summary>
        /// <param name="client">The IRCClient object on which the trigger occurred.</param>
        ...
        public RegexEventArgs(IRCClient client, string channel, IRCUser sender, Match match) {
            this.Client = client;
            this.Channel = channel;
            this.Sender = sender;
            this.Match = match;
